...
import './Mock/ERC2981ContractWideRoyalties.sol';
/**
 @author Chiao-Yu Yang, Justa Liang
 @notice Blindbox: hind the NFT until revealed
 */
contract NFTBlindboxWithRoyalties is NoobFriendlyTokenTemplate, ERC2981ContractWideRoyalties {
...
contract NFTBlindboxGenerator is NoobFriendlyTokenGenerator {
    ...
    function _genContract(
        ...
        return address(new NFTBlindboxWithRoyalties(baseSettings));
    }
}