...
interface NoobFriendlyTokenGeneratorInterface extends ethers.utils.Interface {
  functions: {
...
export class NoobFriendlyTokenGenerator extends Contract {
  ...
  interface: NoobFriendlyTokenGeneratorInterface;
