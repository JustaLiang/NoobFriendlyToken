...
interface NFTGalleryInterface extends ethers.utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "baseURI()": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "initialize(string,uint256,uint128)": FunctionFragment;
...
export class NFTGallery extends Contract {
  ...
  functions: {
    ...
    "initialize(string,uint256,uint128)"(
      baseURI_: string,
      tokenPrice_: BigNumberish,
      startTimestamp_: BigNumberish,
      overrides?: Overrides
