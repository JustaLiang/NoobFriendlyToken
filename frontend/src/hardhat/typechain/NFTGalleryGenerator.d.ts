...
interface NFTGalleryGeneratorInterface extends ethers.utils.Interface {
  functions: {
...
export class NFTGalleryGenerator extends Contract {
  ...
  interface: NFTGalleryGeneratorInterface;
